...
Menu.addCommand( '-> ROI', 'h_viewerShortcuts.CreateOnSelection("ROI")',icon='ROI.png') #Luckily we have added the same icon for the first item =)
Menu.addCommand( '-> Cornerpin (From)', 'h_viewerShortcuts.CreateOnSelection("CornerpinFrom")',icon='CornerPin.png')
Menu.addCommand( '-> Cornerpin (To)', 'h_viewerShortcuts.CreateOnSelection("CornerpinTo")',icon='CornerPin.png')
Menu.addCommand( '-> Cornerpin (From and To)', 'h_viewerShortcuts.CreateOnSelection("CornerpinFromTo")',icon='CornerPin.png')
Menu.addCommand( '-> Crop', 'h_viewerShortcuts.CreateOnSelection("Crop")',icon='Crop.png')
Menu.addCommand( '-> GridWarp', 'h_viewerShortcuts.CreateOnSelection("GridWarp")',icon='GridWarp.png')
Menu.addCommand( '-> Keylight', 'h_viewerShortcuts.CreateOnSelection("Keylight")',icon='Keylight.png')
Menu.addCommand( '-> Radial', 'h_viewerShortcuts.CreateOnSelection("Radial")',icon='Radial.png')
Menu.addCommand( '-> Text', 'h_viewerShortcuts.CreateOnSelection("Text")',icon='Text.png')
Menu.addCommand( '-> Tracker', 'h_viewerShortcuts.CreateOnSelection("Tracker")',icon='Tracker.png')
Menu.addCommand( '-> Transform', 'h_viewerShortcuts.CreateOnSelection("Transform")',icon='2D.png')
